...
<?php
	...
	if ($username == "" || $password == "") {
		...
		die("<A HREF=\"newuser.html\"><BUTTON TYPE=button> Try again or create new account? </BUTTON></A>\n");
	}
...
<A HREF="./about.html"><BUTTON TYPE=button> Proceed to the main page </BUTTON></A><P>
